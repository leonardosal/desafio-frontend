...
!function(){"use strict";var r=["ui.router","ngSanitize"],t=angular.module("app",r);t.config(["$httpProvider",function(r){r.interceptors.push("AuthInterceptor"),r.interceptors.push("LoadingInterceptor"),r.interceptors.push("ErrorInterceptor")}])}();
!function(){"use strict";angular.module("app").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/listagem"),t.state("listagem",{url:"/listagem",templateUrl:"app/views/shot-listagem/listagem.html",controller:"ListagemController",controllerAs:"ListCtrl",resolve:{shots:["ShotsService",function(t){return t.list()}]}}).state("detalhes",{url:"/detalhes/:id",templateUrl:"app/views/shot-detalhes/detalhes.html",controller:"DetalhesController",controllerAs:"DtCtrl",resolve:{shot:["ShotsService","$stateParams",function(t,e){return t.listById(e.id)}]}}).state("erro",{url:"/erro",templateUrl:"error.html"})}])}();
!function(){"use strict";angular.module("app").constant("Constants",{BASE_URL:"https://api.dribbble.com/v1/shots",TOKEN:"c360160eb1b54b46cf819a05bc36daa27c354ba6c1e7157006c35297e4954954"})}();
!function(){"use strict";function t(t,n){function r(){return t.get(n.BASE_URL+"?list=popular")}function u(r){return t.get(n.BASE_URL+"/"+r)}var e={list:r,listById:u};return e}angular.module("app").factory("ShotsService",t),t.$inject=["$http","Constants"]}();
!function(){"use strict";function t(t){return{request:function(n){return n.headers.Authorization="Bearer "+t.TOKEN,n}}}angular.module("app").factory("AuthInterceptor",t),t.$inject=["Constants"]}();
!function(){"use strict";function r(r,t){return{responseError:function(e){return e&&t.get("$state").transitionTo("erro"),r.reject(e)}}}angular.module("app").factory("ErrorInterceptor",r),r.$inject=["$q","$injector"]}();
!function(){"use strict";function n(n,r,t){return{request:function(n){return r.loading=!0,n},requestError:function(t){return r.loading=!1,n.reject(t)},response:function(n){return t(function(){r.loading=!1},500),n},responseError:function(t){return r.loading=!1,n.reject(t)}}}angular.module("app").factory("LoadingInterceptor",n),n.$inject=["$q","$rootScope","$timeout"]}();
!function(){"use strict";function t(t){var o=this;o.shot=t.data}angular.module("app").controller("DetalhesController",t),t.$inject=["shot"]}();
!function(){"use strict";function t(t){var o=this;o.shots=t.data}angular.module("app").controller("ListagemController",t),t.$inject=["shots"]}();